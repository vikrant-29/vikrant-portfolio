  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      <div style={{ textAlign:"center" }}>
        ...
        <p style={{ fontFamily:"var(--font-jetbrains),'JetBrains Mono',monospace", color:"#FF7A00", fontSize:12, letterSpacing:"0.15em", marginBottom:12 }}>ERROR 404</p>
        <h1 style={{ fontFamily:"var(--font-bebas),'Bebas Neue',cursive", fontSize:"clamp(48px,8vw,96px)", letterSpacing:"0.04em", color:"#fff", marginBottom:16 }}>PAGE NOT FOUND</h1>
